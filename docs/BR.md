...
If the CA asserts compliance with these Baseline Requirements, all certificates that it issues MUST comply with one of the following certificate profiles, which incorporate, and are derived from [RFC 5280](https://tools.ietf.org/html/rfc5280). Except as explicitly noted, all normative requirements imposed by RFC 5280 shall apply, in addition to the normative requirements imposed by this document. CAs SHOULD examine [RFC 5280, Appendix B](https://tools.ietf.org/html/rfc5280#appendix-B) for further issues to be aware of.
  ...
  * Section 7.1.2.1 CA Certificates
    * [Section 7.1.2.1.1 - Root CA Certificate Profile](#tbd)
    * [Section 7.1.2.1.2 - TLS Server Authentication Subordinate CA Certificate Profile](#tbd)
    * [Section 7.1.2.1.3 - TLS Server Authentication and Client Authentication Subordinate CA Ceritificate Profile](#tbd)
  * [Section 7.1.2.2 - Subscriber (End-Entity) Certificates
    * [Section 7.1.2.2.1 - Domain Validated Certificates](#tbd)
    * [Section 7.1.2.2.2 - Organization Validated Certificates](#tbd)
    * [Section 7.1.2.2.3 - Extended Validation Certificates](#tbd)
 * Section 7.1.2.3 Infrastructure Certificates
   * [Section 7.1.2.3.1 - Precertificate Profile](#tbd)
   * [Section 7.1.2.3.2 - OCSP Responder Certificate Profile](#tbd)

#### 7.1.2.1 CA Certificates  

##### 7.1.2.1.1 - Root CA Certificate Profile

##### 7.1.2.1.2 - TLS Server Authentication Subordinate CA Certificate Profile

##### 7.1.2.1.3 - TLS Server Authentication and Client Authentication Subordinate CA Ceritificate Profile

#### 7.1.2.2 - Subscriber (End-Entity) Certificates

##### 7.1.2.2.1 - Domain Validated Certificates

##### 7.1.2.2.2 - Organization Validated Certificates

##### 7.1.2.2.3 - Extended Validation Certificates

#### 7.1.2.3 - Infrastructure Certificates

##### 7.1.2.3.1 - Precertificate Profile

##### 7.1.2.3.2 - OCSP Responder Certificate Profile
