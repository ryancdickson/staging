...
### 7.1.2.1 CA Certificate Content and Extensions
...
#### 7.1.2.1.2 Subordinate CA Certificate Profiles

Effective DD-MON-YYYY, all time-valid and unrevoked certificates validating to a Self-signed Root CA adhering to these TLS BRs MUST conform with either the Server Authentication Subordinate CA Certificate Profile or the Server and Client Authentication Subordinate CA Certificate Profile.

#### 7.1.2.1.2.1 Server Authentication Subordinate CA Certificate Profile
...
#### 7.1.2.1.2.2 Server Authentication Subordinate CA Extensions
...
#### 7.1.2.1.2.3 Server and Client Authentication Subordinate CA Certificate Profile
...
#### 7.1.2.1.2.4 Server and Client Authentication Subordinate CA Extensions
...
### 7.1.2.2 Infrastructure Certificate Profiles
